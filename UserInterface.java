 ...
 */
public class UserInterface implements ActionListener //rajoute les methodes Action Listener
 
{
    ...
    {
        this.aMyFrame = new JFrame( "Un joueur Perdu à Anfield" ); // change the title
        ...
        this.aBouton= new JButton("go east");
